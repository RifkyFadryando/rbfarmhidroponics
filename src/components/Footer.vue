<template>
    <footer style="background: #ffffff;border-top: 5px solid #6e4c11;" class="pt-5">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 mb-4">
                    ...
                    <p>
                        Menyatukan cinta terhadap produk lokal yang bergerak di bidang pertanian modern media hiroponik bebas pestisida.
                    </p>
                    <div class="social">
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <p>
                        <i class="fa fa-map-marker"></i> Komplek Duta Mas Block B Jalan Tabrani Ahmad Pontianak Barat, Pontianak, Kalimantan Barat
                    </p>
                </div>
            </div>
            <div class="row text-center mt-3 pb-3">
                <div class="col-md-12">
                    <hr>
                    © <strong>RB Farm</strong> 2021 • Hak Cipta Dilindungi Rifky Fadryando
                </div>
            </div>
        </div>
    </footer>
