                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-borderless mt-3">
                            <tbody>
                                ...
                                <tr>
                                    <td class="font-weight-bold">TERSEDIA</td>
                                    <td>:</td>
                                    <td>
                                        <span class="badge badge-pill badge-success"
                                            style="font-size: 14px;border-radius: .3rem;padding: .25em .5em .2em;"> {{ product.available }}
                                            kilogram</span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>:</td>
                                        <td class="button-container">
                                            ...
                                            <button class="qty-button btn btn-sm btn-secondary" @click="addQty(item.id)">+</button>
                                        </td>
                                </tr> 
